...
export const DashboardPage = () => {
    ...
    // Stats kartları için hesaplamalar
    ...
    // Chart data'yı formatla (12 aylık veri için boş ayları doldur)
    const chartData = Array.from({ length: 12 }, (_, i) => {
        const monthData = monthlyIncome.find(item => item.month === i + 1);
        return {
            month: i,
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <StatCard
                            ...
                            value={`%${occupancyRate}`}
                            trend={`${stats?.occupiedUnits || 0}/${stats?.totalUnits || 0}`}
                            trendUp={Number(occupancyRate) > 50}
                            trendText={t('dashboard.statsLabels.lastMonth')}
                            variant="orange"
                            hasChart={true}
                            icon={UserPlus}
                        ...
                        <StatCard
                            ...
                            value={String(stats?.pendingMaintenance || 0)}
                            trend={`+${stats?.pendingJanitor || 0}`}
                            trendUp={true}
                        ...
                        <StatCard
                            ...
                            value={String(stats?.dailyBookings || 0)}
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <div className="animate-in fade-in slide-in-from-bottom-5 duration-700 delay-200">
                                    <MaintenanceList maintenance={recentMaintenance} />
                                </div>
                            </>
                        )}
                    </div>
