            ...
            <div className="space-y-5">
                <div className="space-y-1.5">
                    ...
                    <select
                        ...
                        className="w-full bg-ds-input-light dark:bg-ds-input-dark border border-ds-border-light dark:border-ds-border-dark rounded-xl px-3 py-2.5 text-sm text-ds-primary-light dark:text-ds-primary-dark focus:outline-none focus:border-ds-action transition-colors appearance-none cursor-pointer"
                    >
