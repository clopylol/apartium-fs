...
export const CourierRowSkeleton: FC = () => (
  <tr className="border-b border-ds-border-light dark:border-ds-border-dark animate-pulse">
    ...
    <td className="px-6 py-4">
      <div className="h-6 w-24 bg-ds-muted-light dark:bg-ds-muted-dark rounded-md" />
    </td>
    <td className="px-6 py-4 text-right">
      <div className="h-8 w-24 bg-ds-muted-light dark:bg-ds-muted-dark rounded-lg ml-auto" />
    </td>
  </tr>
);
