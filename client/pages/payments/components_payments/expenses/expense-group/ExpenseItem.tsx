        ...
        <div className="p-4 flex items-center justify-between hover:bg-ds-muted-dark/20 transition-colors group">
            ...
            <div className="flex items-center gap-6">
                <div className="text-right">
                    <div className={`font-bold ${expense.status === 'paid' ? 'text-[#10b981]' : 'text-[#ef4444]'}`}>₺{expense.amount.toLocaleString()}</div>
                    <div className={`text-[10px] font-bold uppercase tracking-wider mt-0.5 ${expense.status === 'paid' ? 'text-[#10b981]' : 'text-[#ef4444]'}`}>
